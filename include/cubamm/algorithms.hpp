/**
 * @file
 * @brief Integration algorithms
 *
 * This header defines the Cuba integration algorithms. To avoid clashes
 * with the Cuba integration routines all names are in lower case.
 *
